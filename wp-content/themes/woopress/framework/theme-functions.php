...
if (!function_exists('etheme_logo')) {
    function etheme_logo($fixed_header = false) {
        ...
        $custom_logo = etheme_get_custom_field('custom_logo');
    ...
    function et_insert_fb_in_head() {
        ...
        if ( !is_singular()) //if it is not a post or a page
            ...
            if(!has_post_thumbnail( $post->ID )) { 
                $default_image = get_site_url().'/wp-content/themes/woopress/images/staticks/facebook-default.jpg'; 
        ...
        if ( $query->have_posts() ) {
            ...
            if($title != '') {
                ?>
                    ...
                    <h5 class="title"><span><?php if($link): ?><a href="<?php echo esc_url( get_home_url().'/?s='.$args['s'].'&post_type='.$args['post_type'] ); ?>" title="<?php echo esk_attr(__('Show all',ETHEME_DOMAIN)); ?>"><?php endif; ?>
                        <?php echo $title; ?>
...
if(!function_exists('et_back_to_page')) {
    function et_back_to_page() {
        echo '<a class="back-history" href="javascript: history.go(-1)">'.__('Quay lại trang trước',ETHEME_DOMAIN).'</a>';
    }
}
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="about-company">
                                <a class="pull-left" href="#"><img title="WooPressStore" src="<?php echo PARENT_URL.'/images/logo.png'; ?>" alt="..."><br></a>
                            </div>
                            <p>Website mua bán đồ uy tính nhiều ưu đãi.</p>
                            <address class="address-company"><br>
                                <span class="white-text">Phone</span>: +0164 909 5077<br>
                                <span class="white-text">Email</span>: <a href="mailto:tranvannhut4495@gmail.com">Team@UIT.com</a><br>
                                <a class="white-text letter-offset" href="#">www.nhutuit.com</a><br>
                                <?php echo etheme_share_shortcode(array()); ?>
                            </address>
                        </div>
                        <div class="col-md-3">
                            <div class="widget-container widget_text">
                                <h3 class="widget-title"><span>Các mặt hàng phổ biến</span></h3>
...
<!--                                     <ul class="col-ct-6 lít-unstyled">
                        ...
                        <div class="col-md-3">
                            <?php
                                ...
                                $instance = array(
                                    ...
                                    'number' => 6,
                                    'show_button' => 1,
                                    'title' => __('Hình ảnh', ETHEME_DOMAIN)
                                );
                        ...
                        <div class="col-md-3">
                            <?php the_widget('Etheme_Recent_Posts_Widget', array('title' => __('Nhưng bài viết gần đây', ETHEME_DOMAIN), 'number' => 2), array('before_title' => '<h3 class="widget-title">','after_title' => '</h3>', 'number' => 2)); ?>
                        </div>
                    </div>
            ...
            case 'footer9':
                ?>  
                    <div class="textwidget">
                        <p><!-- Created with <i class="fa fa-heart default-colored"></i> by <a href="#" class="default-link">8Thêm</a>. --> All Rights Reserved</p>
                    </div>
                <?php
                break;
            case 'footer10':
