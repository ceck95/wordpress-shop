		...
		<div id="review_form_wrapper">
			<div id="review_form">
				<?php
					...
					$comment_form = array(
						'title_reply'          => '<span>' . __('Để lại bình luận', ETHEME_DOMAIN) . '</span>',
					...
					$comment_form['comment_field'] .= '<div class="form-group"><label for="comment" class="control-label">'.__('Bình luận của bạn', ETHEME_DOMAIN).'</label><textarea class="form-control required-field"  id="comment" name="comment" cols="45" rows="12" aria-required="true"></textarea></div>';
